...
class HumachLab_CHBMIT_EEGFeatureExtractor:
    ...
    def __init__(self, logger, data_frame_segment, channel_name, manage_exceptional_data=0, signal_frequency = 256, sample_per_second=1280, filtering_enabled=False, lowcut=1, highcut=48):
        ...
        td_nonlinear_features = ['permutationEntropy', 'spectralEntropy', 'singularValueDecompositionEntropy', 'approximateEntropy',
                                 'sampleEntropy', 'fuzzyEntropy', 'distributionEntropy', 'shannonEntropy', 'renyiEntropy']
        td_nonlinear_features2_complexity_and_fractal_dimensions = ['lempelZivComplexity', 'hjorthMobility', 'hjorthComplexity',
        ...
        td_nonlinear_features3_samp_entropy_profiling = ['entropyProfiled_total_sampleEntropy', 'entropyProfiled_average_sampleEntropy', 'entropyProfiled_maximum_sampleEntropy',
        ...
        self.feature_list = td_statistical_features + td_nonlinear_features + td_nonlinear_features2_complexity_and_fractal_dimensions + td_nonlinear_features3_samp_entropy_profiling \
                            + fd_statistical_features
