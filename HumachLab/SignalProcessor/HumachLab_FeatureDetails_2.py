...
class HumachLab_FeatureDetails:
    ...
    td_nonlinear_entropy = ['approximateEntropy', 'sampleEntropy', 'permutationEntropy', 'singularValueDecompositionEntropy',
    ...
    td_nonlinear_samp_entropy_profiling = ['entropyProfiled_total_sampleEntropy', 'entropyProfiled_average_sampleEntropy',
                                           'entropyProfiled_maximum_sampleEntropy', 'entropyProfiled_minimum_sampleEntropy',
                                           'entropyProfiled_median_sampleEntropy', 'entropyProfiled_standardDeviation_sampleEntropy',
                                           'entropyProfiled_variance_sampleEntropy', 'entropyProfiled_kurtosis_sampleEntropy',
    ...
    fd_linear_statistical_binwise = ['fd_maximum_alpha', 'fd_minimum_alpha', 'fd_mean_alpha', 'fd_median_alpha', 'fd_standardDeviation_alpha', 'fd_variance_alpha', 'fd_kurtosis_alpha', 'fd_skewness_alpha',
    ...
    fd_linear_statistical_binwise_short = ['fd_max_alpha', 'fd_min_alpha', 'fd_mean_alpha', 'fd_med_alpha', 'fd_std_alpha', 'fd_var_alpha', 'fd_kur_alpha', 'fd_skew_alpha',
                                           'fd_max_beta', 'fd_min_beta', 'fd_mean_beta', 'fd_med_beta', 'fd_std_beta', 'fd_var_beta', 'fd_kur_beta', 'fd_skew_beta',
                                           'fd_max_delta', 'fd_min_delta', 'fd_mean_delta', 'fd_med_delta', 'fd_std_delta', 'fd_var_delta', 'fd_kur_delta', 'fd_skew_delta',
                                           'fd_max_theta', 'fd_min_theta', 'fd_mean_theta', 'fd_med_theta', 'fd_std_theta', 'fd_var_theta', 'fd_kur_theta', 'fd_skew_theta',
                                           'fd_max_other', 'fd_min_other', 'fd_mean_other', 'fd_med_other', 'fd_std_other', 'fd_var_other', 'fd_kur_other', 'fd_skew_other']
    fd_linear_statistical_binwise_short2 = ['FD_MaxAlp', 'FD_MinAlp', 'FD_MeanAlp', 'FD_MedAlp', 'FD_StdAlp', 'FD_VarAlp', 'FD_KurAlp', 'FD_SkewAlp',
                                           'FD_MaxBet', 'FD_MinBet', 'FD_MeanBet', 'FD_MedBet', 'FD_StdBet', 'FD_VarBet', 'FD_KurBet', 'FD_SkewBet',
                                           'FD_MaxDel', 'FD_MinDel', 'FD_MeanDel', 'FD_MedDel', 'FD_StdDel', 'FD_VarDel', 'FD_KurDel', 'FD_SkewDel',
                                           'FD_MaxThe', 'FD_MinThe', 'FD_MeanThe', 'FD_MedThe', 'FD_StdThe', 'FD_VarThe', 'FD_KurThe', 'FD_SkewThe',
                                           'FD_MaxOth', 'FD_MinOth', 'FD_MeanOth', 'FD_MedOth', 'FD_StdOth', 'FD_VarOth', 'FD_KurOth', 'FD_SkewOth']

    fd_nonlinear_entropy = ['spectralEntropy']
    fd_nonlinear_entropy_short = ['specEn']
    fd_nonlinear_entropy_short2 = ['SpecEn']

    fd_spectral_band_power = ['fd_bandPower', 'fd_bandPower_alpha', 'fd_bandPower_beta', 'fd_bandPower_delta',
                              'fd_bandPower_theta', 'fd_bandPower_other']
    fd_spectral_band_power_short = ['fd_bandPw', 'fd_bandPw_alpha', 'fd_bandPw_beta', 'fd_bandPw_delta', 'fd_bandPw_theta',
                                    'fd_bandPw_other']
    fd_spectral_band_power_short2 = ['fd_bandPw', 'fd_bandPwAlp', 'fd_bandPwBet', 'fd_bandPwDel', 'fd_bandPwThe',
                                    'fd_bandPwOth']
    ...
    def __init__(self):
        ...
        self.all_features_short = self.td_linear_statistical_short + self.td_nonlinear_entropy_short +\
                                  ...
                                  self.fd_linear_statistical_binwise_short + self.fd_nonlinear_entropy_short + self.fd_spectral_band_power_short
        self.all_features_short2 = self.td_linear_statistical_short2 + self.td_nonlinear_entropy_short2 +\
                                  ...
                                  self.fd_linear_statistical_binwise_short2 + self.fd_nonlinear_entropy_short2 + self.fd_spectral_band_power_short2
        return
