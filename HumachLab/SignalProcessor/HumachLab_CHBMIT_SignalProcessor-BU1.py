            ...
            for rec in pat_copy.records:
                ...
                for ch in data.ch_names:
                    ...
                    while seg_st<end_time:
                        ...
                        feat_ext_obj = HumachLab_CHBMIT_EEGFeatureExtractor(self.logger, data_frame_segment, manage_exceptional_data=2, signal_frequency=samp_rate, sample_per_second=segment_duration_in_samples, filtering_enabled=True)
